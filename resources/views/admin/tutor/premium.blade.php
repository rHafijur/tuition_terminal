...
@endphp
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <div class="row">
                <ul id="tab_nav" class="nav nav-pills">
                    ...
                    <li class="nav-item"><a href="{{cb()->getAdminUrl("tutors/premium")}}" class="nav-link active">Primium Tutors</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="report-card card">
                        <h2>{{$reports['todays']}}</h2>
                        <span>Todays</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="report-card card">
                        <h2>{{$reports['tuiton_received']}}</h2>
                        <span>Tuition Received</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="box-body">
            ...
            <form action="{{cb()->getAdminUrl("tutors/premium")}}" method="GET">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{Carbon::parse($tutor->premium_started_at)->toDateString()}}
                            </td>
                            <td>
                                {{Carbon::parse($tutor->premium_started_at)->addDay(30)->toDateString()}}
                            </td>
                            <td>
                                @if ($premiumBy=$tutor->premiumBy)
                                    {{$premiumBy->name}}
                                @endif
                            </td>
                            <td>
