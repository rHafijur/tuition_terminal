                ...
                <div id="filters" class="hide card card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col">
                            ...
                            @endphp
                            <select class="select2 form-control required-input select2-hidden-accessible" name="course_subject_ids[]" id="course_subject_ids"  multiple="" data-placeholder="Select a State" style="width: 100%;" data-select2-id="" tabindex="-1" aria-hidden="true">
