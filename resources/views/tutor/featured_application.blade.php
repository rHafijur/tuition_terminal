@extends('tutor.layouts.master',['title'=>'Featured Tutor Request'])
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card-header">
            <h3 class="card-title">Payment Information for Featured Tutor Request</h3>
        </div>
      <div class="card card-primary card-outline">
        <div class="card-body box-profile">
          <form action="{{route('post_tutor_featured_request')}}" method="POST">
            @csrf
