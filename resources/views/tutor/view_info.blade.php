    ...
    <div class="col-md-3">
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          ...
          <p class="text-muted">
            {{$tutor->tutor_degree->degree_title}} from the {{$tutor->tutor_degree->institute->title}}
          </p>
          ...
          <p class="text-muted">{{$tutor->tutor_personal_information->location->name}}, {{$tutor->tutor_personal_information->city->name}}</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">              
                        ...
                        <p class="text-muted">{{$pi->location->name}}, {{$pi->city->name}}</p>
