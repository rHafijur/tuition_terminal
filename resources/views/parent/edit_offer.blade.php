        ...
        <div id="tab_content" class="tab-content">
            <div class="active tab-pane" id="student_information">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control required-input" value="{{$offer->tutoring_duration}}" name="tutoring_duration" id="tutoring_duration" type="number">
                    <div class="invalid-feedback">
            ...
            <div class="tab-pane" id="tutor_requirement">
                ...
                <div class="form-group">
                    ...
                    @endphp
                    <select class="form-control required-input select2 select2-hidden-accessible" name="tutor_university_ids[]" multiple="" id="tutor_university_id" data-placeholder="Select a University" data-select2-id="" style="width: 100%;" tabindex="-1" aria-hidden="true">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="year_or_semester" value="{{$offer->year_or_semester}}" name="year_or_semester" class="form-control required-input">
                    <div class="invalid-feedback">
                ...
                <div class="form-group">
                    <label>Board </label>
                    <select  name="board" class="form-control required-input">
